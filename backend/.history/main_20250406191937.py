...
# CONFIGURATION
# --------------------
SECRET_KEY = "your-secret-key"  # Replace with a secure key from your environment.
ALGORITHM = "HS256"
...
# EMAIL CONFIGURATION
# --------------------
# Configure these settings with your email provider’s details.
conf = ConnectionConfig(
    MAIL_USERNAME="intelliclaimapp@gmail",      # Your email address
    MAIL_PASSWORD="your_email_password",           # Your email password or app password
    MAIL_FROM="your_email@example.com",            # The sender's email address
    MAIL_PORT=587,                                 # Typical port for TLS
    MAIL_SERVER="smtp.gmail.com",                  # For example, Gmail SMTP server
    MAIL_TLS=True,
    MAIL_SSL=False,
